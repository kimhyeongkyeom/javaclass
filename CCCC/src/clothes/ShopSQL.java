...
public class ShopSQL {
	...
	public void newMember() {
		...
		new Client(memberno, name, birth, gender, 
				   password, phone, addr, account);
	...
	public void order(int id,String name, String size, String color,
					  String price) {
	...
	public boolean pay2(String name1) {
		...
		switch (pay) {
	case 1:
		System.out.println("결재하실 금액은 " + cost(name1) + "입니다.");
	...
	case 2:
		System.out.println("결제하실 금액은 " +  cost(name1) + "입니다.");
